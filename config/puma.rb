...
if RAILS_ENV == 'development'
  ...
  application_path = "/www/robbin/current"
end
...
if RAILS_ENV != 'development'
stdout_redirect "#{application_path}/log/puma.out.log", "#{application_path}/log/puma.err.log", true
end
...
# The default is "0".
#
workers({production: 2}[(ENV['RAILS_ENV'] || ENV['RACK_ENV'] || 'production').to_sym])
